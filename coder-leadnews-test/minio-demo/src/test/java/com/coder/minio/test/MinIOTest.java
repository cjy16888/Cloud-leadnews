...
//        String path = fileStorageService.uploadHtmlFile("", "list.html", fileInputStream);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MinioClient minioClient = MinioClient.builder().credentials("minio", "minio123").endpoint("http://192.168.23.133:9000").build();
            ...
            //访问路径
//            System.out.println("http://192.168.23.133:9000/leadnews/list.html");
        } catch (Exception e) {
            e.printStackTrace();
        }
